...
namespace ShiftEverywhere.DiMETest
{
    public class Commons
    {
        ...
        private const string _encodedTrustedKeybox = "a2V5.eyJraWQiOiI3ZDA2ZjFhOC03YjdmLTRlNGItYjg3Yy0xMjE5NjQxNTE2ZTUiLCJpYXQiOjE2MjYyMTM2OTUsImtleSI6IkNZSGpZUGVTV2g4U3lmY0hveXVxZnR4TndzeEdUcTNSQVVQWHZhamRYMkJNRDF1UDhkOUxvUiIsInB1YiI6IkNZSHQ2UDZmNTZoSGRxaE1GUW1UMlYzYTlOS3hKUkxhOEFWS2hEc0hRZFhYeTNGVEtwUzdYTSJ9";
        private const string _encodedTrustedIdentity = "aWQ..ARxE0YAIkTm7cyeZgJx4P0Orc6xLfUpt2k175pPdUhe9XZHMWB/8U/H347+83MH2NR0JIxxrwHxJ2F5HTiUioA8";
        private static KeyBox _trustedKeybox;
        private static Identity _trustedIdentity;
        #endregion

        #region -- INTERMEDIATE IDENTITY --
        private const string _encodedIntermediateKeypair = "a2V5.eyJraWQiOiJhYThkNzE3YS1iYWUyLTRmZDgtODI1My1iM2I0NDJkMGFlZWUiLCJpYXQiOjE2MjYyMTM3NzQsImtleSI6IkNZSGpYMkRBanFFaWtudHFuaFdNcXJySHRaS0ZEOVROcFZISDE1cFF6Vm51R3RwcEpjUWY5UyIsInB1YiI6IkNZSHQ3MzZOaHVEVnl3SmM3Vk5yeU5CTm4zWHZuVjk2c1RKZ2hxRlZYZGJLWGlRam15cFdYeCJ9";
        private const string _encodedIntermediateIdentity = "aWQ..AcSvOxWLuozJxsQjG1DC3SK8F6qgGeNAepkYCFyTj+qAfyG1biQIJ+xFEDPIwrygtvNT1WFwnQYOCwd0GctIiQw";
        private static KeyBox _intermediateKeybox;
        private static Identity _intermediateIdentity;
        #endregion

        #region -- SENDER IDENTITY --
        private const string _encodedSenderKeybox = "a2V5.eyJraWQiOiIyZDQ2YzYzMC1mNTQ4LTRmNzUtODYwZC01ZTE3NzNkODU0OWQiLCJpYXQiOjE2MjYyMTM4NDUsImtleSI6IkNZSGpYazU1aUNWek00MWdDUjlOcmhLcXhkalNQcDJHMUUxU0xjOGNBbk5EY0I0UnZQWDlzWCIsInB1YiI6IkNZSHQ3dFNUcTU5RnlwdEpVTktNVDhuUHRlcnhadG44M2dyUlNyZGdyNk5zVGs3cWgzQUdQYyJ9";
        private const string _encodedSenderIdentity = "aWQ...AZrIMEZAvKFz6u699TfpQwpnJnyI594i9MmTPHH9YV6A0W2wFO/fwff9yoIO9t7eSycnTVe2AaVpo7jCG2XtMgE";
        private static KeyBox _senderKeybox;
        private static Identity _senderIdentity;
        #endregion

        #region -- RECEIVER IDENTITY --
        private const string _encodedReceiverKeybox = "a2V5.eyJraWQiOiI5N2I5YmYxZC02ZTZhLTRkNGYtYWZkOC05MDg2N2MwNGVhMDkiLCJpYXQiOjE2MjYyMTM4NzgsImtleSI6IkNZSGpXeFBObnhobXVRd2ZOVEJVZTNHWTNSV0VMRFBEdFJaNHVYQWlGekNmNmgxc29BTlk5ZiIsInB1YiI6IkNZSHQ4Nm5iZXU0ZnZveDdyd3pkTldjZmpibk1KN3M1c3dLa0pOQUgzckxVZ2I3MXZ3bktoaSJ9";
        private const string _encodedReceiverIdentity = "aWQ...AZXzc94/LuBBqqwMSZ/WUR26z0MRbBCcW/akiCc7o6mpXjLdK4bEwXMqEHk9Sctb3x0e4sQTUW/4H+3fuP1NNgs";
