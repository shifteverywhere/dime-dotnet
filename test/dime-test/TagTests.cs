...
public class TagTests
{
    ...
    public void AddItemLinkTest5() 
    {
        ...
        Assert.AreEqual(Commons.TrustedIdentity.GenerateThumbprint(false), link0.Thumbprint);
        var link1 = links[1];
        ...
        Assert.AreEqual(Commons.IntermediateIdentity.GenerateThumbprint(false), link1.Thumbprint);
        var link2 = links[2];
        ...
        Assert.AreEqual(Commons.IssuerIdentity.GenerateThumbprint(false), link2.Thumbprint);
        var link3 = links[3];
        ...
        Assert.AreEqual(Commons.AudienceKey.GenerateThumbprint(false), link3.Thumbprint);
    }
