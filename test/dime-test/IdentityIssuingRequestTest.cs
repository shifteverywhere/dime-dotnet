...
{  
    ...
    public void SystemNameTest2() {
        ...
        var caps = new List<Capability> { Capability.Generic };
        var identity = IdentityIssuingRequest.Generate(Key.Generate(KeyType.Identity)).Issue(Guid.NewGuid(), 100L, Commons.IntermediateKey, Commons.IntermediateIdentity, true, caps, null, system);
